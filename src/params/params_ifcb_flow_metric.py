...
class IFCBTrainingParams(BaseModel):
    ...
    # Feature selection flags - Spatial Statistics Features
    ...
    # Feature selection flags - Distribution Shape Features
    ...
    # Feature selection flags - Clipping Detection Features
    ...
    # Feature selection flags - Histogram Uniformity Features
    ...
    # Feature selection flags - Statistical Moments Features
    ...
    # Feature selection flags - PCA Orientation Features
    ...
    # Feature selection flags - Edge Detection Features
    ...
    # Feature selection flags - Temporal Features
